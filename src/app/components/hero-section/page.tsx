...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-blue-600/10 blur-[120px] rounded-full animate-pulse" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-blue-800/10 blur-[150px] rounded-full animate-pulse delay-700" />
        ...
        <div className="order-2 lg:order-1 flex flex-col items-start gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="hero-heading text-lg md:text-xl text-slate-400 max-w-xl leading-relaxed font-medium">
              ...
              a professional
              <span
                className="text-blue-500 ml-2 font-bold inline-block min-w-[200px]"
                ref={designationRef}
              >
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              <Link
                ...
                target="_blank"
                className="social-icon p-3 rounded-xl bg-white/5 border border-white/10 text-white hover:text-blue-500 hover:border-blue-500/50 transition-all duration-300 shadow-xl"
              >
                <BsGithub size={24} />
              </Link>
              <Link
            ...
            <div className="hero-cta flex flex-wrap gap-4">
              <Link
                href="/#contact"
                className="group relative px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold uppercase tracking-wider overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(59,130,246,0.3)]"
              >
              ...
              <Link
                ...
                target="_blank"
                className="group px-8 py-4 rounded-2xl border border-white/10 bg-white/5 text-white font-bold uppercase tracking-wider transition-all hover:bg-white/10 hover:border-blue-500/50 flex items-center gap-2"
              >
                Get Resume{" "}
                ...
                <code className="font-mono text-xs md:text-sm lg:text-base leading-relaxed">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-blue-300">'Khushboo Gupta'</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-blue-300">'Fullstack Mastery'</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-blue-400">"Build with Purpose"</span>
                    </p>
                  </div>
                  <div className="flex gap-4">
