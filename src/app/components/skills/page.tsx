...
const SkillItem = ({ skill }: { skill: string }) => {
  ...
  return (
    <div className="mx-4 my-4 group">
      <div className="relative px-8 py-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-3xl transition-all duration-500 hover:border-blue-500/30 hover:bg-white/[0.05] flex items-center gap-4 shadow-xl">
        <div
        ...
        <div className="flex flex-col">
          <span className="text-sm font-bold text-white tracking-wide uppercase group-hover:text-blue-500 transition-colors">
            {skill}
          </span>
