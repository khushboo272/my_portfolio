    ...
    >
      ...
      <div className="flex justify-center mb-20 lg:mb-32">
        <div className="flex items-center">
          ...
          <span className="bg-[#050505] border border-blue-600/30 w-fit text-white p-3 px-8 text-2xl font-bold rounded-full shadow-[0_0_20px_rgba(37,99,235,0.2)]">
      ...
      <div className="max-w-6xl mx-auto px-4 relative">
        ...
        <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-blue-600 via-blue-900 to-transparent opacity-30" />
          ...
          {experiences.map((exp, index) => (
            <div key={exp.id} className="relative">
              <SectionReveal direction={index % 2 === 0 ? "right" : "left"}>
                ...
                >
                  {/* Timeline Dot */}
                  <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 top-0 w-10 h-10 rounded-xl bg-[#050505] border-2 border-blue-600 flex items-center justify-center z-10 shadow-[0_0_15px_rgba(37,99,235,0.5)]">
                    <BsPersonWorkspace className="text-blue-600 w-5 h-5" />
                  </div>
                  ...
                  >
                    <div className="group relative p-8 rounded-3xl border border-white/10 bg-white/[0.02] backdrop-blur-md hover:border-blue-600/50 transition-all duration-500 shadow-xl hover:shadow-blue-600/10">
                      ...
                      <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-blue-600/20 via-transparent to-blue-800/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                    </div>
                  </div>
                </div>
              </SectionReveal>
