          ...
          <div className="relative z-10 p-8 lg:p-16 flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
              <div className="flex flex-wrap gap-3">
                ...
                <Badge
                  variant="secondary"
                  className="bg-blue-900/20 text-blue-400 hover:bg-black border-blue-800/30 px-3 py-1 font-bold tracking-wider"
                >
                  {project.role}
                </Badge>
              </div>
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                ...
                {project.code && (
                  <Link href={project.code} target="_blank">
                    <Button
                      variant="outline"
                      className="border-white/10 bg-white/5 hover:bg-blue-900/20 hover:text-blue-500 hover:border-blue-500/30 text-white px-8 py-6 text-lg rounded-xl transition-all hover:scale-105 active:scale-95 flex gap-2 font-bold uppercase tracking-widest"
                    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-16">
            ...
            <section className="flex flex-col gap-8">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-blue-500/10 flex items-center justify-center border border-blue-500/20">
                  <ShieldCheck className="w-6 h-6 text-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.5)]" />
                </div>
              ...
              <ul className="grid grid-cols-1 gap-4">
                {project.highlights?.map((highlight, index) => (
                  ...
                  >
                    <div className="mt-1.5 w-2 h-2 rounded-full bg-blue-600 shadow-[0_0_10px_rgba(37,99,235,0.8)] shrink-0 group-hover:scale-125 transition-transform" />
            ...
            {project.images && project.images.length > 1 && (
              <section className="flex flex-col gap-8">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-blue-800/10 flex items-center justify-center border border-blue-800/20">
          ...
          <aside className="flex flex-col gap-8">
            ...
            <Card className="bg-[#050505]/20 border-white/10 rounded-3xl overflow-hidden sticky top-24 shadow-2xl">
              <CardContent className="p-8 flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-blue-800/10 flex items-center justify-center">
